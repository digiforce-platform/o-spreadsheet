...
// Colors
export const HIGHLIGHT_COLOR = "#4096ff";
export const BACKGROUND_GRAY_COLOR = "#f5f5f5";
export const BACKGROUND_HEADER_COLOR = "#F8F9FA";
export const BACKGROUND_HEADER_SELECTED_COLOR = "#E6F4FF";
export const BACKGROUND_HEADER_ACTIVE_COLOR = "#4096ff";
export const TEXT_HEADER_COLOR = "#666666";
export const FIGURE_BORDER_COLOR = "#d9d9d9";
export const SELECTION_BORDER_COLOR = "#1677ff";
export const HEADER_BORDER_COLOR = "#d9d9d9";
export const CELL_BORDER_COLOR = "#d9d9d9";
export const BACKGROUND_CHART_COLOR = "#FFFFFF";
export const DISABLED_TEXT_COLOR = "rgba(0, 0, 0, 0.25)";
export const DEFAULT_COLOR_SCALE_MIDPOINT_COLOR = 0xb6d7a8;
export const LINK_COLOR = HIGHLIGHT_COLOR;
export const FILTERS_COLOR = "#1677ff";
export const BACKGROUND_HEADER_FILTER_COLOR = "#E6F4FF";
export const SEPARATOR_COLOR = "rgba(5, 5, 5, 0.06)";
export const ICONS_COLOR = "rgba(0, 0, 0, 0.45)";
export const HEADER_GROUPING_BACKGROUND_COLOR = "#F5F5F5";
export const HEADER_GROUPING_BORDER_COLOR = "#d9d9d9";
export const GRID_BORDER_COLOR = "#d9d9d9";
export const FROZEN_PANE_HEADER_BORDER_COLOR = "#d9d9d9";
export const FROZEN_PANE_BORDER_COLOR = "#d9d9d9";
export const COMPOSER_ASSISTANT_COLOR = "#1677ff";
export const COLOR_TRANSPARENT = "#00000000";
export const TABLE_HOVER_BACKGROUND_COLOR = "#017E8414";

export const CHART_WATERFALL_POSITIVE_COLOR = "#1677ff";
export const CHART_WATERFALL_NEGATIVE_COLOR = "#ff4d4f";
export const CHART_WATERFALL_SUBTOTAL_COLOR = "#rgba(0, 0, 0, 0.45)";
...
export const PRIMARY_BUTTON_BG = "#1677ff";
export const PRIMARY_BUTTON_HOVER_BG = "#4096ff";
export const PRIMARY_BUTTON_ACTIVE_BG = "#0958d9";
export const BUTTON_BG = "#ffffff";
export const BUTTON_HOVER_BG = "#ffffff";
export const BUTTON_HOVER_TEXT_COLOR = "#4096ff";
export const BUTTON_ACTIVE_BG = "#ffffff";
export const BUTTON_ACTIVE_TEXT_COLOR = "#0958d9";
export const ACTION_COLOR = "#1677ff";
export const ACTION_COLOR_HOVER = "#4096ff";
export const ALERT_WARNING_BG = "#fffbe6";
export const ALERT_WARNING_BORDER = "#fff1b8";
export const ALERT_WARNING_TEXT_COLOR = "#faad14";
export const ALERT_DANGER_BG = "#fff2f0";
export const ALERT_DANGER_BORDER = "#ffccc7";
export const ALERT_DANGER_TEXT_COLOR = "#ff4d4f";
export const ALERT_INFO_BG = "#e6f4ff";
export const ALERT_INFO_BORDER = "#91caff";
export const ALERT_INFO_TEXT_COLOR = "#1677ff";
export const BADGE_SELECTED_COLOR = "#e6f4ff";
...
export const DESKTOP_TOPBAR_TOOLBAR_HEIGHT = 30;
export const MOBILE_TOPBAR_TOOLBAR_HEIGHT = 44;
export const DESKTOP_BOTTOMBAR_HEIGHT = 36;
export const MOBILE_BOTTOMBAR_HEIGHT = 44;
...
export const MOBILE_MENU_ITEM_HEIGHT = 35;
